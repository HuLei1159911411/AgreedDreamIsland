...
public class TestPanel : Panel
{
    ...
    public void ListenPanelShowAndClose()
    {
        ...
        if (isShow && Input.GetKeyDown(KeyCode.Keypad6))
        {
            GivePower();
        }
    }
    ...
    {
        _isGivenPower = true;
        PlayerCharacter.Instance.maxHp = 100f;
        PlayerCharacter.Instance.hp = 100f;
        PlayerCharacter.Instance.maxStamina = 100f;
        PlayerCharacter.Instance.stamina = 100f;
    ...
    {
        _isGivenPower = false;
        PlayerCharacter.Instance.maxHp = 10f;
        PlayerCharacter.Instance.hp = 10f;
        PlayerCharacter.Instance.maxStamina = 10f;
        PlayerCharacter.Instance.stamina = 10f;
